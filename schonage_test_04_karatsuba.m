...
% Instead of school-book, we will use Karatsuba

disp('==== Karatsuba 512 ======')

% Calculate by 6 FFT multiplications (Karatsuba)

% TEST: Check FFT Values

f_split01_00_fft = FFT_Forward_32_512to3232(f_split01(0+1,:));
f_split01_01_fft = FFT_Forward_32_512to3232(f_split01(1+1,:));
f_split01_02_fft = FFT_Forward_32_512to3232(f_split01(2+1,:));

g_split01_00_fft = FFT_Forward_32_512to3232(g_split01(0+1,:));
g_split01_01_fft = FFT_Forward_32_512to3232(g_split01(1+1,:));
g_split01_02_fft = FFT_Forward_32_512to3232(g_split01(2+1,:));



disp('--- Term of z^0: f0g0 ---')

f0g0 = FFT_32_multiplication(f_split01(0+1,:),g_split01(0+1,:));

disp('--- f1g1 ---')

f1g1 = FFT_32_multiplication(f_split01(1+1,:),g_split01(1+1,:));

disp('--- Term of z^4: f2g2 ---')

f2g2 = FFT_32_multiplication(f_split01(2+1,:),g_split01(2+1,:));

disp('--- Term of z^1 ---')

% (f0*g1+f1*g0)*z

addition_f0_f1 = f_split01(0+1,:)+f_split01(1+1,:);
addition_g0_g1 = g_split01(0+1,:)+g_split01(1+1,:);

%term_z1 = mod(FFT_32_multiplication(addition_f0_f1, addition_g0_g1)-f0g0-f1g1,2048);
term_z1 = FFT_32_multiplication(addition_f0_f1, addition_g0_g1)-f0g0-f1g1;

disp('--- Term of z^3 ---')

% (f1*g2+f2*g1)*z^3

addition_f1_f2 = f_split01(1+1,:)+f_split01(2+1,:);
addition_g1_g2 = g_split01(1+1,:)+g_split01(2+1,:);

%term_z3 = mod(FFT_32_multiplication(addition_f1_f2, addition_g1_g2)-f1g1-f2g2,2048);
term_z3 = FFT_32_multiplication(addition_f1_f2, addition_g1_g2)-f1g1-f2g2;

disp('--- Term of z^2 ---')

% (f0*g2 + f1*g1 + f2*g0)*z^2

addition_f0_f2 = f_split01(0+1,:)+f_split01(2+1,:);
addition_g0_g2 = g_split01(0+1,:)+g_split01(2+1,:);

%term_z2 = mod(FFT_32_multiplication(addition_f0_f2, addition_g0_g2)-f0g0-f2g2+f1g1,2048);
term_z2 = FFT_32_multiplication(addition_f0_f2, addition_g0_g2)-f0g0-f2g2+f1g1;

disp('===== De-rotate Good ======')

h_goodRotated = [mod(f0g0+term_z3,2048), mod(term_z1+f2g2,2048), mod(term_z2,2048)] %This has the correct values, but rotated as per Good's rotation, we must de-rotate
